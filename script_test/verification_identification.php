...
COMMIT;';
  ...
  if ($connection && $login) 
  {
    ...
    if ($upload) {$log .= '<span style="color:#090">Le téléversement par FTP a réussi !</span><br>';}
	else {$log .= '<span style="color:#900">Le téléversement par FTP a échoué !</span><br>';}
  } 
  else {$log .= 'La tentative de connexion FTP a échoué !<br>';}
